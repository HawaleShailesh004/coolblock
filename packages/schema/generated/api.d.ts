export interface paths {
    ...
    "/plans/{plan_id}/scenarios/{version}/memo": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /**
         * Generate Memo
         * @description §7.1 L3/L6: the council memo, verified by the numeric provenance
         ...
         *     sections.
         */
        post: operations["generate_memo_plans__plan_id__scenarios__version__memo_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /**
         * MemoNumberOut
         * @description One number the memo's text cites, and whether L6's provenance
        ...
        MemoOut: {
            ...
            text: string;
            /** Numbers */
            numbers: components["schemas"]["MemoNumberOut"][];
            /** Unverified Count */
...
export interface operations {
    ...
    generate_memo_plans__plan_id__scenarios__version__memo_post: {
        parameters: {
            query?: {
